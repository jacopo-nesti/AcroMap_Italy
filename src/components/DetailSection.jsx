  ...
  return (
    <div className="col-12 col-md-6">
      ...
      >
        ...
        <i className={`bi bi-chevron-${isOpen ? 'up' : 'down'} small position-absolute end-0 me-3`}></i>
      </button>

      {/* Sezione contenuti ad espansione */}
      {isOpen && (
        <div ref={ref} className="p-2 bg-light rounded-3 border border-success-subtle">
          {count > 0 ? (
